...
' ----------------------------------------------------------------
    Const COMPS_EXCLUDED As String = "clsLog, clsQ, fMsg,mBasic,mErH,mMsg, mNme, mRef, mReg, mRng, mShp, mFso, mDct, mTrc, mWbk, mWsh, mCompManClient"
...
'    Set wbk = Application.Workbooks("CompMan.xlsb")
    ...
    Application.Run UNUSED_SERVICE, ActiveWorkbook, COMPS_EXCLUDED, LINES_EXCLUDED
